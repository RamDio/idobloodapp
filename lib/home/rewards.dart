            ...
            Expanded(
              ...
              height: 80,
                ...
                elevation: 10,
                  ...
                  title: Row(
                    children: <Widget>[
                      new Text("P500 Load",style:TextStyle(fontWeight:FontWeight.w900,fontSize: 30)),
                       new Text("1 Pt.",style:TextStyle(fontWeight:FontWeight.w900,fontSize: 20)),
                    ],
                  ),
                
                  leading: new Icon(FontAwesomeIcons.checkCircle,size: 20,),
                ),
              ),
            ),
          ),
